...
def bkapp(doc):
    ...
    data = pd.read_csv("server/vaers_jan_nov_2021.csv", usecols=['VAERS_ID', "SYMPTOM1", "SYMPTOM2", "SYMPTOM3", "SYMPTOM4", "SYMPTOM5", 'SEX', 'STATE', 'AGE_YRS', 'VAX_MANU', 'ALLERGIES', 'HISTORY'], encoding='utf-8-sig', encoding_errors='ignore')
